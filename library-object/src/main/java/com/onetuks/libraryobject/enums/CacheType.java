...
public enum CacheType {
  ...
  RECOMMENDED_MEMBERS(CacheName.RECOMMENDED_MEMBERS, 60 * 10, 100),
  REVIEW_FEED(CacheName.REVIEW_FEED, 60 * 5, 1_000),
  BOOK_PICKS(CacheName.BOOK_PICKS, 60 * 5, 1_000),
  REVIEW_PICKS(CacheName.REVIEW_PICKS, 60 * 5, 1_000),
  MEMBER_FOLLOWS(CacheName.MEMBER_FOLLOWS, 60 * 5, 1_000),
  SEARCHED_BOOKS(CacheName.SEARCHED_BOOKS, 60 * 5, 1_000);
