package com.onetuks.libraryexternal.book.handler.dto;

import com.onetuks.libraryexternal.book.handler.dto.vo.AuthorNameData;
import com.onetuks.libraryexternal.book.handler.dto.vo.CoverImageUrlData;
import com.onetuks.libraryexternal.book.handler.dto.vo.IsbnData;
import com.onetuks.libraryexternal.book.handler.dto.vo.KdcData;
import com.onetuks.libraryexternal.book.handler.dto.vo.PublisherData;
import com.onetuks.libraryexternal.book.handler.dto.vo.TitleData;
import com.onetuks.libraryexternal.book.handler.strategy.dto.BibliographyQueryResponse;
import com.onetuks.libraryexternal.book.handler.strategy.dto.BibliographyQueryResponse.BibliographyQueryData;
import com.onetuks.libraryexternal.book.handler.strategy.dto.CollectionQueryResponse;
import com.onetuks.libraryexternal.book.handler.strategy.dto.CollectionQueryResponse.CollectionQueryData;
